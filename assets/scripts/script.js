...
const board = (() => {
  ...
  const firstRow = [cellList[0], cellList[1], cellList[2]];
  const secondRow = [cellList[3], cellList[4], cellList[5]];
  const thirdRow = [cellList[6], cellList[7], cellList[8]];
